    ...
    <SidebarProvider>
      <Sidebar className="border-r border-sidebar-border/50">
        ...
        <SidebarContent>
          ...
          <SidebarGroup>
            <Collapsible
              open={isReceptionOpen}
              onOpenChange={setIsReceptionOpen}
              className="group/collapsible"
            >
              <SidebarMenu>
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton tooltip="Reception">
                      <Calendar />
                      <span>Reception</span>
                      <ChevronDown className="ml-auto transition-transform duration-200 group-data-[state=open]/collapsible:rotate-180" />
                    </SidebarMenuButton>
          ...
          <SidebarGroup>
            <Collapsible
              open={isDoctorOpen}
              onOpenChange={setIsDoctorOpen}
              className="group/collapsible"
            >
              <SidebarMenu>
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton tooltip="Doctor">
                      <Stethoscope />
                      <span>Doctor</span>
                      <ChevronDown className="ml-auto transition-transform duration-200 group-data-[state=open]/collapsible:rotate-180" />
                    </SidebarMenuButton>
          ...
          <SidebarGroup>
            <Collapsible
              open={isClinicsOpen}
              onOpenChange={setIsClinicsOpen}
              className="group/collapsible"
            >
              <SidebarMenu>
                <SidebarMenuItem>
                  <CollapsibleTrigger asChild>
                    <SidebarMenuButton tooltip="Clinics">
                      <Building />
                      <span>Clinics</span>
                      <ChevronDown className="ml-auto transition-transform duration-200 group-data-[state=open]/collapsible:rotate-180" />
                    </SidebarMenuButton>
